...
int main( )
{
	...
	for (i = 0; i < N; ++i)  acadoVariables.lbValues[ i ] = -0.8;
	for (i = 0; i < N; ++i)  acadoVariables.ubValues[ i ] = 0.8;
	...
	//acadoVariables.lbAValues[N] = 0.0;
	//acadoVariables.lbAValues[N] = 0.0;
